...
$sqlprom = "SELECT * FROM im_productos where estado =1 "; #AND inicio_promocion <= now() AND fin_promocion >= now() ORDER BY inicio_promocion LIMIT 4
$resprom = $con->query($sqlprom);
?>
<!DOCTYPE html>
...
<head>
    ...
    <title>Productos - EFECTIV FHARMA</title>
...
<body id="productos" onload="listar('A');">
    ...
    <div class="row topicos">
        <!-- promociones-->
        <div class="col-lg-10 col-md-12 col-sm-12 promociones">
                        <h4>Productos en promoción</h4> <br>
  ...
  <?php          	echo "<ul>";
	while($row = mysqli_fetch_assoc($resprom)){	
          //$fila++;
            ...
            echo '<li><a href="'.$ubicacion.'" target="_blank"><img width="80px" src="'.$imagen.'" style="border-radius: 0 30px 0 30px"> <br> '.$nombre.'</a><br><a>Precio: Bs.<del>'.$precio.'</del> '.$precio_rebajado.'</a></li>';
        } /* cierre del while */
        ...
        <div class="col-lg-2 col-md-12 col-sm-12">
            <div class="row">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12">
                    ...
                    <img src="img/post-23.jpg" width="250px" alt="">
                </div>
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <p>3. Envío de comprobante de pago al WhatsApp Empresarial</p> <br>
                </div>
